...
# 📊 GitHub Stats:
![](https://github-readme-stats.shion.dev/api?username=deepthi-mahendran&theme=dark&hide_border=false&include_all_commits=true&count_private=true)<br/>
![](https://streak-stats.demolab.com/?user=deepthi-mahendran&theme=dark&hide_border=false)<br/>
...
React, TypeScript, Tailwind, LocalStorage – weighted mastery tracking, dark mode, countdowns.

🔹 **[Elegant Notes – Offline-First PWA](https://eleganth-notes-demo.vercel.app/)**  
React, Supabase, Tiptap, Zustand, PWA – real-time sync, sharing with slugs, animations.

🔹 **[Titanic Survival Analysis (EDA)](https://github.com/deepthi-aiml/titanic-eda)**  
Python, Pandas, Seaborn, Matplotlib – feature engineering, imputation pipeline, rich visualizations.

---

## 📜 Certifications & Courses

- AI/ML Engineering (Stage 2) – SLIIT *(ongoing)*  
- Postman API Fundamentals Student Expert *(ongoing)*  
- Server-Side Web Development – UoM *(ongoing)*  
